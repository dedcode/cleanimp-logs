...
Last updated: 2026-03-29 17:20:19 UTC
...
Job status (17100 total):
  completed   :  16020  (93.7%)
  in progress :   1070  (6.3%)
  failed      :     10

  active now  :    672  (across 9 servers)
...
Progress: 16020/17100 (93.7%) — $\color{green}{completed}$ / $\color{blue}{running}$ / $\color{red}{failed}$ (done%)
...
| GRIN | ✅ | ✅ | $\color{green}{125}$ / $\color{blue}{1}$ / $\color{red}{0}$ (83%) | $\color{green}{425}$ / $\color{blue}{1}$ / $\color{red}{0}$ (94%) |
...
| MRNN | ✅ | ✅ | $\color{green}{122}$ / $\color{blue}{11}$ / $\color{red}{0}$ (81%) | $\color{green}{422}$ / $\color{blue}{11}$ / $\color{red}{0}$ (93%) |
...
| Moment | ✅ | ✅ | $\color{green}{120}$ / $\color{blue}{9}$ / $\color{red}{0}$ (80%) | $\color{green}{420}$ / $\color{blue}{9}$ / $\color{red}{0}$ (93%) |
...
| SoftImpute | ✅ | ✅ | $\color{green}{121}$ / $\color{blue}{14}$ / $\color{red}{0}$ (80%) | $\color{green}{421}$ / $\color{blue}{14}$ / $\color{red}{0}$ (93%) |
...
| **TOTAL** | **$\color{green}{5700}$ / $\color{blue}{0}$ / $\color{red}{0}$ (100%)** | **$\color{green}{5700}$ / $\color{blue}{0}$ / $\color{red}{0}$ (100%)** | **$\color{green}{4620}$ / $\color{blue}{311}$ / $\color{red}{10}$ (81%)** | **$\color{green}{16020}$ / $\color{blue}{311}$ / $\color{red}{10}$ (93%)** |
