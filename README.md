...
_Last updated: **2026-05-23 04:05:01 -0400**. Refreshes every 5 min via cron on bigdata.1._
...
| `cif` | 276/1095 (25%) | 245/1083 (23%) | 127/1095 (12%) | 20% |
| `cnn` | **done** | **done** | 1050/1095 (96%) | 98% |
| `itde` | **done** | — | 1094/1095 (100%) | 100% |
| `knn` | **done** | **done** | 1047/1095 (96%) | 98% |
| `lstm` | 1068/1095 (98%) | 394/436 (90%) | 821/1095 (75%) | 87% |
| `proxstump` | 1092/1095 (100%) | — | 1074/1095 (98%) | 99% |
| `shapedtw` | 389/1095 (36%) | 14/704 (2%) | 405/1095 (37%) | 28% |
| `signature` | 885/1095 (81%) | 0/210 (0%) | 885/1095 (81%) | 74% |
| `stc` | **done** | **done** | 993/1095 (91%) | 95% |
| `svc` | 1052/1095 (96%) | 150/187 (80%) | 914/1095 (83%) | 89% |
| `tsf` | **done** | **done** | 1094/1095 (100%) | 100% |
| `tsfresh` | **done** | **done** | 1088/1095 (99%) | 100% |
| `weasel` | **done** | — | **done** | 100% |
| **total** | **15712/17520** | **897/2714** | **14923/17520** | **84%** |
