...
_Last updated: **2026-05-23 01:30:01 -0400**. Refreshes every 5 min via cron on bigdata.1._
...
| `cif` | 22/1095 (2%) | 180/1083 (17%) | 106/1095 (10%) | 9% |
| `cnn` | 1082/1095 (99%) | **done** | 992/1095 (91%) | 95% |
| `itde` | **done** | — | 1094/1095 (100%) | 100% |
| `knn` | 1092/1095 (100%) | **done** | 1028/1095 (94%) | 97% |
| `lstm` | 695/1095 (63%) | 314/436 (72%) | 730/1095 (67%) | 66% |
...
| `stc` | 1034/1095 (94%) | **done** | 963/1095 (88%) | 91% |
| `svc` | 882/1095 (81%) | 122/187 (65%) | 901/1095 (82%) | 80% |
| `tsf` | **done** | **done** | 1094/1095 (100%) | 100% |
| `tsfresh` | **done** | **done** | 1081/1095 (99%) | 99% |
| `weasel` | **done** | — | 1094/1095 (100%) | 100% |
| **total** | **14838/17520** | **724/2714** | **14532/17520** | **80%** |
