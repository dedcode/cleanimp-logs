...
Last updated: 2026-03-29 19:10:17 UTC
...
Progress: 16479/17100 (96.4%) — $\color{green}{completed}$ / $\color{blue}{running}$ / $\color{red}{failed}$ (done%)
...
| DeepMVI | ✅ | ✅ | $\color{green}{133}$ / $\color{blue}{11}$ / $\color{red}{0}$ (88%) | $\color{green}{433}$ / $\color{blue}{11}$ / $\color{red}{0}$ (96%) |
...
| NuwaTS | ✅ | ✅ | $\color{green}{122}$ / $\color{blue}{16}$ / $\color{red}{2}$ (82%) | $\color{green}{422}$ / $\color{blue}{16}$ / $\color{red}{2}$ (94%) |
...
| **TOTAL** | **$\color{green}{5700}$ / $\color{blue}{0}$ / $\color{red}{0}$ (100%)** | **$\color{green}{5700}$ / $\color{blue}{0}$ / $\color{red}{0}$ (100%)** | **$\color{green}{5079}$ / $\color{blue}{256}$ / $\color{red}{8}$ (89%)** | **$\color{green}{16479}$ / $\color{blue}{256}$ / $\color{red}{8}$ (96%)** |
