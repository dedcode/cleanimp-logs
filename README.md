...
Last updated: 2026-03-29 18:55:20 UTC
...
Progress: 16466/17100 (96.3%) — $\color{green}{completed}$ / $\color{blue}{running}$ / $\color{red}{failed}$ (done%)
...
| HKMFT | ✅ | ✅ | $\color{green}{128}$ / $\color{blue}{3}$ / $\color{red}{3}$ (87%) | $\color{green}{428}$ / $\color{blue}{3}$ / $\color{red}{3}$ (95%) |
| IIM | ✅ | ✅ | $\color{green}{132}$ / $\color{blue}{6}$ / $\color{red}{0}$ (88%) | $\color{green}{432}$ / $\color{blue}{6}$ / $\color{red}{0}$ (96%) |
...
| MPIN | ✅ | ✅ | $\color{green}{133}$ / $\color{blue}{4}$ / $\color{red}{0}$ (88%) | $\color{green}{433}$ / $\color{blue}{4}$ / $\color{red}{0}$ (96%) |
...
| MissNet | ✅ | ✅ | $\color{green}{139}$ / $\color{blue}{2}$ / $\color{red}{0}$ (92%) | $\color{green}{439}$ / $\color{blue}{2}$ / $\color{red}{0}$ (97%) |
...
| **TOTAL** | **$\color{green}{5700}$ / $\color{blue}{0}$ / $\color{red}{0}$ (100%)** | **$\color{green}{5700}$ / $\color{blue}{0}$ / $\color{red}{0}$ (100%)** | **$\color{green}{5066}$ / $\color{blue}{256}$ / $\color{red}{9}$ (89%)** | **$\color{green}{16466}$ / $\color{blue}{256}$ / $\color{red}{9}$ (96%)** |
