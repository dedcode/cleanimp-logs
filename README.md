...
_Last updated: **2026-05-23 01:45:01 -0400**. Refreshes every 5 min via cron on bigdata.1._
...
| `cif` | 62/1095 (6%) | 180/1083 (17%) | 108/1095 (10%) | 11% |
| `cnn` | 1094/1095 (100%) | **done** | 992/1095 (91%) | 95% |
| `itde` | **done** | — | 1094/1095 (100%) | 100% |
| `knn` | **done** | **done** | 1028/1095 (94%) | 97% |
| `lstm` | 775/1095 (71%) | 314/436 (72%) | 743/1095 (68%) | 70% |
...
| `stc` | 1074/1095 (98%) | **done** | 963/1095 (88%) | 93% |
| `svc` | 931/1095 (85%) | 122/187 (65%) | 902/1095 (82%) | 82% |
| `tsf` | **done** | **done** | 1094/1095 (100%) | 100% |
| `tsfresh` | **done** | **done** | 1081/1095 (99%) | 99% |
| `weasel` | **done** | — | 1094/1095 (100%) | 100% |
| **total** | **15062/17520** | **724/2714** | **14548/17520** | **80%** |
