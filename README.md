...
Last updated: 2026-03-29 18:23:33 UTC
...
Progress: 16400/17100 (95.9%) — $\color{green}{completed}$ / $\color{blue}{running}$ / $\color{red}{failed}$ (done%)
...
| BayOTIDE | ✅ | ✅ | $\color{green}{124}$ / $\color{blue}{19}$ / $\color{red}{0}$ (82%) | $\color{green}{424}$ / $\color{blue}{19}$ / $\color{red}{0}$ (94%) |
| BitGraph | ✅ | ✅ | $\color{green}{127}$ / $\color{blue}{16}$ / $\color{red}{0}$ (84%) | $\color{green}{427}$ / $\color{blue}{16}$ / $\color{red}{0}$ (94%) |
| CDRec | ✅ | ✅ | $\color{green}{126}$ / $\color{blue}{16}$ / $\color{red}{0}$ (84%) | $\color{green}{426}$ / $\color{blue}{16}$ / $\color{red}{0}$ (94%) |
| CSDI | ✅ | ✅ | $\color{green}{126}$ / $\color{blue}{15}$ / $\color{red}{0}$ (84%) | $\color{green}{426}$ / $\color{blue}{15}$ / $\color{red}{0}$ (94%) |
| DeepMVI | ✅ | ✅ | $\color{green}{130}$ / $\color{blue}{11}$ / $\color{red}{0}$ (86%) | $\color{green}{430}$ / $\color{blue}{11}$ / $\color{red}{0}$ (95%) |
| DynaMMo | ✅ | ✅ | $\color{green}{128}$ / $\color{blue}{10}$ / $\color{red}{0}$ (85%) | $\color{green}{428}$ / $\color{blue}{10}$ / $\color{red}{0}$ (95%) |
| GAIN | ✅ | ✅ | $\color{green}{127}$ / $\color{blue}{8}$ / $\color{red}{0}$ (84%) | $\color{green}{427}$ / $\color{blue}{8}$ / $\color{red}{0}$ (94%) |
| GPT4TS | ✅ | ✅ | $\color{green}{128}$ / $\color{blue}{7}$ / $\color{red}{2}$ (86%) | $\color{green}{428}$ / $\color{blue}{7}$ / $\color{red}{2}$ (95%) |
...
| IIM | ✅ | ✅ | $\color{green}{131}$ / $\color{blue}{3}$ / $\color{red}{0}$ (87%) | $\color{green}{431}$ / $\color{blue}{3}$ / $\color{red}{0}$ (95%) |
| Interpolation | ✅ | ✅ | $\color{green}{136}$ / $\color{blue}{1}$ / $\color{red}{0}$ (90%) | $\color{green}{436}$ / $\color{blue}{1}$ / $\color{red}{0}$ (96%) |
...
| NuwaTS | ✅ | ✅ | $\color{green}{115}$ / $\color{blue}{18}$ / $\color{red}{3}$ (78%) | $\color{green}{415}$ / $\color{blue}{18}$ / $\color{red}{3}$ (92%) |
| PRISTI | ✅ | ✅ | $\color{green}{132}$ / $\color{blue}{6}$ / $\color{red}{1}$ (88%) | $\color{green}{432}$ / $\color{blue}{6}$ / $\color{red}{1}$ (96%) |
...
| TimesNet | ✅ | ✅ | $\color{green}{128}$ / $\color{blue}{19}$ / $\color{red}{0}$ (85%) | $\color{green}{428}$ / $\color{blue}{19}$ / $\color{red}{0}$ (95%) |
...
| **TOTAL** | **$\color{green}{5700}$ / $\color{blue}{0}$ / $\color{red}{0}$ (100%)** | **$\color{green}{5700}$ / $\color{blue}{0}$ / $\color{red}{0}$ (100%)** | **$\color{green}{5000}$ / $\color{blue}{256}$ / $\color{red}{9}$ (87%)** | **$\color{green}{16400}$ / $\color{blue}{256}$ / $\color{red}{9}$ (95%)** |
