...
_Last updated: **2026-05-24 08:25:01 -0400**. Manual refresh: `bash /storage/experiments/cleanimp/orchestrator/push_status.sh`._
...
|---|---:|
| Total jobs | **21,580** |
| Completed (PRED on disk) | **19,849** (92.0%) |
| Retry queues (`:5555` moment+patchtst, `:5557` arima) | running=1469, pending=239, failed=23 |

### Progress by (Forecaster × Algorithm)

| Forecaster | Dynammo | GPT4TS | MICE | MeanImpute | SAITS | SoftImpute | Row % |
|---|:---:|:---:|:---:|:---:|:---:|:---:|---:|
| `arima` | 197/240 (82%) | 182/240 (76%) | 198/240 (82%) | 192/240 (80%) | 189/240 (79%) | 188/239 (79%) | 80% |
...
| **total** | **3317/3600** | **3302/3600** | **3318/3600** | **3308/3595** | **3309/3600** | **3295/3585** | **92%** |
...
| `svc` | 1084/1095 (99%) | **done** | 1090/1095 (100%) | 99% |
| `tsf` | **done** | **done** | **done** | 100% |
| `tsfresh` | **done** | **done** | **done** | 100% |
| `weasel` | **done** | — | **done** | 100% |
| **total** | **15836/17520** | **1053/2714** | **15871/17520** | **87%** |
